 ...
 */
 ...
 public class OutputSolr extends Output<LogFeederProps, InputMarker> {
   ...
   private void initParams(LogFeederProps logFeederProps) throws Exception {
     ...
     implicitRouting = logFeederProps.isSolrImplicitRouting(); // TODO: w przyszłości możliwe jest ładowanie tej wartości z konfiguracji output
     if (implicitRouting) {
   ...
   class SolrWorkerThread extends Thread {
     ...
     private void addRouterField() {
       // Używamy metody getClusterStateProvider() zamiast getZkStateReader() (klasa ZkStateReader została usunięta w Solr 9.8.0)
